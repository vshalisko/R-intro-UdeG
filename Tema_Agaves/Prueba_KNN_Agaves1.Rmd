---
title: "Prueba KNN (años agrupados)"
...
grupos2 <- 2 * floor(data[,5] / 2)
data <- cbind(data,grupos2)

data$grupos2 <- as.factor(data$grupos2)
clases <- levels(data$grupos2)
clases
...
data_entrenamiento_clase <- as.factor(data_entrenamiento$grupos2)
...
data_prueba_clase <- as.factor(data_prueba$grupos2)
