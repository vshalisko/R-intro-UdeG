...
censo_2010A_sel$POBFEM <- as.numeric(censo_2010A_sel$POBFEM)
censo_2010A_sel$POBMAS <- as.numeric(censo_2010A_sel$POBMAS)
...
boxplot(censo_2010A_sel[,c("POBFEM","POBMAS")], col = c("coral","lightblue"))
...
# categoríaspara clasificación 
rangos <- c(0,0.25,0.35,0.4,0.45,0.48,0.52,0.55,0.6,0.65,0.75,1)

# generar vectores con gama de colores conforme a categorias
#as.numeric(cut(municipios_jalisco@data$FEM_PROP_MENORES, rangos))
municipios_jalisco@data$Col1 <- hcl.colors(12)[as.numeric(cut(municipios_jalisco@data$FEM_PROP_MENORES, 
                                                         rangos))]

municipios_jalisco@data$Col2 <- hcl.colors(12)[as.numeric(cut(municipios_jalisco@data$FEM_PROP_MAYORES, 
                                                         rangos))]
...
legend("topleft", fill = hcl.colors(12), 
       #col = municipios_jalisco@data$Col1,
       legend = rangos * 100)
