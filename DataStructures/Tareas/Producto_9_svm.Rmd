...
### Variante con SVM (Support Vechot Machones) para casos cuando el metodo MaxEnt no funciono (por ejemplo, por problemas en configuración de rJava)
...
specie_data <- cbind(x,y)
names(specie_data) <- c(paste('b',1:19,sep=''),"y")

# inferir el modelo SVM
...
str(modelo_svm)
summary(modelo_svm)
plot(modelo_svm, data = specie_data, x ~ b1)
```
